...
import { CalendarIcon, Printer, Search, UserPlus } from "lucide-react"
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-[1500px] mx-auto px-4 py-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="w-48">
            <img src="/MALABAR_ACADEMIC_CITY_HOSPITAL_LOGO_page-0001__1_-removebg-preview.png" alt="Malabar Academic City Hospital" className="w-full h-full" />
          </div>
        </div>

        <div className="grid grid-cols-2 gap-4 mb-6">
          <Button variant="outline" className="h-14 text-base font-medium" onClick={() => setActiveTab("register")}>
            <UserPlus className="mr-2 h-5 w-5" /> New Patient
          </Button>
          <Button
            className="h-14 text-base font-medium bg-blue-500 hover:bg-blue-600"
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex gap-2">
                  <Input placeholder="Search by OP Number, Name or Phone" className="flex-1" />
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-y-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {typeof registeredPatient.doctor === "object" ? registeredPatient.doctor.name : "Assigned Doctor"}
                    </p>
                  </div>
                  <div>
